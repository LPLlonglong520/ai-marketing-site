...
function loadVideo(wrapper){
  if(wrapper.dataset.loading==='1') return; // 防止重复触发
  ...
  vid.addEventListener('canplay',function(){
    ...
    vid.play().catch(function(){}); // 移动端可能需要用户手势，静默失败
  },{once:true});
