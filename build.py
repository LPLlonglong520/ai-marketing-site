...
/* ═══════════ 营销+AI 业务架构section ═══════════ */
.arch-section { background: linear-gradient(180deg, #060f25 0%, #0a1638 60%, #070e2a 100%); padding: 50px 28px 55px; position: relative; overflow: hidden; }
...
.arch-sub { text-align: center; font-size: 15px; color: rgba(255,255,255,.6); margin: 0 auto 32px; line-height: 1.5; max-width: 100%; padding: 0 16px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
